...
public class TesteHeranca {
	...
	public static void main(String[] args) {
		...
		ContaPoupanca cp = new ContaPoupanca(); //instancia um obj do tipo ContaPoupan�a
		cp.depositar(10000D); //define o saldo do objeto conta poupan�a
		...
		//especificas de uma conta poupan�a, cujas funcionalidades especificas
		//foram definidas na classe conta poupan�a e tem seu metodos limitados apenas a aqueles
		//contidos na classe pai
		//ou seja, os metodos ADICIONADOS a classe especifica, n�o s�o visiveis para o programa
		//a menos que se fa�a cast
		c = new ContaPoupanca();
